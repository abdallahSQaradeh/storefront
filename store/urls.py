...
from .views import ProductImageViewSet, ProductViewSet, CollectionViewSet,\
...
products_router.register("images",viewset=ProductImageViewSet, basename="product-images")
